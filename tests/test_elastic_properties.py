...
def test_elastic_properties_converter_complex_approach() -> None:
    ...
    calculated_models = [
        ElasticPropertiesConverter.convert_from_bulk_and_youngs(reference_model.bulk_modulus, reference_model.youngs_modulus),
        ElasticPropertiesConverter.convert_from_bulk_and_lame(reference_model.bulk_modulus, reference_model.lame_parameter),
        ElasticPropertiesConverter.convert_from_bulk_and_shear(reference_model.bulk_modulus, reference_model.shear_modulus),
        ElasticPropertiesConverter.convert_from_bulk_and_poissons(reference_model.bulk_modulus, reference_model.poissons_ratio),
        ElasticPropertiesConverter.convert_from_bulk_and_p_wave(reference_model.bulk_modulus, reference_model.p_wave_modulus),
        ElasticPropertiesConverter.convert_from_youngs_and_lame(reference_model.youngs_modulus, reference_model.lame_parameter),
        ElasticPropertiesConverter.convert_from_youngs_and_shear(reference_model.youngs_modulus, reference_model.shear_modulus),
        ElasticPropertiesConverter.convert_from_youngs_and_poissons(reference_model.youngs_modulus, reference_model.poissons_ratio),
        ElasticPropertiesConverter.convert_from_youngs_and_p_wave(reference_model.youngs_modulus, reference_model.p_wave_modulus),
        ElasticPropertiesConverter.convert_from_lame_and_shear(reference_model.lame_parameter, reference_model.shear_modulus),
        ElasticPropertiesConverter.convert_from_lame_and_poissons(reference_model.lame_parameter, reference_model.poissons_ratio),
        ElasticPropertiesConverter.convert_from_lame_and_p_wave(reference_model.lame_parameter, reference_model.p_wave_modulus),
        ElasticPropertiesConverter.convert_from_shear_and_poissons(reference_model.shear_modulus, reference_model.poissons_ratio),
        ElasticPropertiesConverter.convert_from_shear_and_p_wave(reference_model.shear_modulus, reference_model.p_wave_modulus),
        ElasticPropertiesConverter.convert_from_poissons_and_p_wave(reference_model.poissons_ratio, reference_model.p_wave_modulus),
    ]
...
def test_elastic_properties_convert_from_velosity() -> None:
    calculated_model = ElasticPropertiesConverter.convert_dynamic_elastic_properties_from_velocity(30, 20, 2.5)
...
def test_elastic_properties_convert_from_slowness() -> None:
    calculated_model = ElasticPropertiesConverter.convert_dynamic_elastic_properties_from_slowness(1000000, 2000000, 2500000)
