...
class ElasticProperties:
    ...
    Attributes:
        ...
        lames_first_parameter (float): Lame parameters are two material-dependent quantities denoted by λ and μ that arise in strain-stress relationships.
...
class ElasticPropertiesConverter:
    """A static converter creating complete ElasticProperties model based on variation of any two moduli
    ...
    def from_bulk_and_youngs_modulus(bulk_modulus: float, youngs_modulus: float) -> ElasticProperties:
        """
        Creates complete ElasticProperties model from bulk and youngs modulus
